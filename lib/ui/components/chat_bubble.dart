    ...
    if (isSender) {
      switch (status) {
        case MessageStatus.notSent:
          ...
          //   Icons.info,
          //   size: chatMessageStatusIconFontSize,
        ...
        child: CustomPaint(
          ...
          child: Container(
            ...
            child: Stack(
              children: <Widget>[
                Padding(
                  padding: const EdgeInsets.only(left: 4, right: 10, bottom: 20),
                  child: Text(
                    text,
                    style: textStyle,
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: chatMessageStatusIconFontSize - 6,
                          
                        ),
                      ),
                      const SizedBox(width: 5),
                      stateIcon != null && status != MessageStatus.notSent && stateTick ? stateIcon : const SizedBox.shrink()
                    ],
                  ),
                ),
              ],
